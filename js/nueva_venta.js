$(function () {
  ...
  function buscarArticulo(id){
    ...
    if(encontrado == false){
      alertify.error('No se ha encontrado el artículo.');
      vaciarArticulo();
      $('#consultarArticulo').modal('show');	 	
    }
  }
  ...
  $(document).on("click", ".btn-det", function () {
    ...
    alertify.confirm('Confirmar', ' ¿Está seguro de quitar el registro?',
    function(){
    ...
    function(){
    }).set({labels:{ok:'Sí, confirmar!', cancel: 'Cancelar'}, padding: false});
  ...
  function guardarVenta() {
    ...
    if(puede){
      ...
      if(puede){
        ...
        alertify.confirm('Confirmar', ' ¿Está seguro de guardar el registro de venta?',
        function(){
  ...
  function cerrarVenta(){
    if(clienteCargado() == true || detalles.length > 0){
      alertify.confirm('Confirmar', ' ¿Está seguro de cerrar el registro de venta?',
      function(){
        window.location.href = "./menu.html";
      },
      function(){
  ...
  function cancelarVenta(){
    if(clienteCargado() == true || detalles.length > 0){
      alertify.confirm('Confirmar', ' ¿Está seguro de cancelar el registro de venta?',
      function(){
        limpiarForm();
      },
      function(){

...
/* Aquí va la lógica de lado del cliente*/
    ...
    $('#form').submit(function(e) {
        let postData = {
            id : id,
            nombre : $('#nombre-clasificacion').val().toUpperCase()
        };
        
        if($('#nombre-clasificacion').val().length === 0){
            alertify.error('Campo vacio, complete los campos principales.');
            $('#nombre-clasificacion').focus();
        }else{
            if(validarClasificación(postData.nombre)){
                if(id < 1){
                ...
                alertify.error('El nombre de la clasificacion ya esta registrado.'); 
            }        
        }
        e.preventDefault();
    });
    ...
    function validarClasificación(nombre) {
    ...
    document.getElementById('nuevo').addEventListener("click", function(){
        id = 0;
        document.getElementById('titulo-clasificacion').innerHTML = 'Nueva Clasificación.';
        document.getElementById('form').reset();
        ...
        setTimeout(function () {
            document.getElementById("nombre-clasificacion").focus();	
        }, 500);
    });
    ...
    $(document).on("click", ".btn-edit", function(){		
        ...
        document.getElementById('titulo-clasificacion').innerHTML = 'Editar Clasificación.';
        document.getElementById('btn-form').innerHTML = 'Modificar.';
        document.getElementById('nombre-clasificacion').value = nombre;
